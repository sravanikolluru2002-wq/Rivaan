...
@font-face {
  ...
  font-weight: 400;
  font-display: swap;
  src: url("e60cd8c8-3d64-4f73-8675-0f151a22d6f3") format('woff2');
...
@font-face {
  ...
  font-weight: 400;
  font-display: swap;
  src: url("c0e1d062-4d47-4173-9292-27eaeae5be04") format('woff2');
...
@font-face {
  ...
  font-weight: 400;
  font-display: swap;
  src: url("90f64d0b-83cf-45da-953b-d61b4ecc445e") format('woff2');
...
@font-face {
  ...
  font-weight: 400;
  font-display: swap;
  src: url("2398dcb2-0e3e-4b98-8096-5507e59cfea2") format('woff2');
...
<style>
  *{box-sizing:border-box}
  body{margin:0;font-family:'Plus Jakarta Sans',system-ui,sans-serif;-webkit-font-smoothing:antialiased;background:#eef2ec}
  .ad-scroll::-webkit-scrollbar{width:9px;height:9px}
  .ad-scroll::-webkit-scrollbar-thumb{background:#d2ddce;border-radius:8px}
  .ad-scroll::-webkit-scrollbar-track{background:transparent}
  .ad-kpi{display:grid;grid-template-columns:repeat(5,1fr);gap:16px}
  .ad-g3{display:grid;grid-template-columns:1fr 1fr 1fr;gap:18px;align-items:start}
  .ad-g2{display:grid;grid-template-columns:1fr 1fr;gap:18px;align-items:start}
  .ad-hamb{display:none}
  @media(max-width:1300px){.ad-kpi{grid-template-columns:repeat(3,1fr)}}
  @media(max-width:1160px){.ad-g3{grid-template-columns:1fr 1fr}}
  @media(max-width:860px){
    .ad-side{position:fixed !important;z-index:90;left:-300px;transition:left .26s cubic-bezier(.22,.61,.36,1);height:100vh}
    .ad-side.open{left:0;box-shadow:0 20px 60px rgba(9,32,16,.35)}
    .ad-kpi{grid-template-columns:repeat(2,1fr)}
    .ad-g3,.ad-g2{grid-template-columns:1fr}
    .ad-hamb{display:flex}
    .ad-tbl-wrap{overflow-x:auto}
  }
  @media(max-width:520px){.ad-kpi{grid-template-columns:1fr}.ad-hidesm{display:none !important}}
  .ad-fade{animation:adF .34s cubic-bezier(.22,.61,.36,1) both}
  @keyframes adF{from{opacity:0;transform:translateY(8px)}to{opacity:1;transform:translateY(0)}}
...
<div style={{'height': '100vh', 'display': 'flex', 'overflow': 'hidden', 'background': '#eef2ec', 'color': '#16231a'}}>
  ...
  <aside className={`ad-side ${sideCls}`} style={{'flex': 'none', 'width': '252px', 'background': '#0f2e1a', 'display': 'flex', 'flexDirection': 'column'}}>
    <div style={{'padding': '22px 22px 16px', 'display': 'flex', 'alignItems': 'center', 'gap': '11px', 'borderBottom': '1px solid rgba(255,255,255,.08)'}}>
      <span style={{'width': '36px', 'height': '36px', 'borderRadius': '10px', 'background': '#fff', 'display': 'flex', 'alignItems': 'center', 'justifyContent': 'center', 'flex': 'none'}}><img src="d091e371-15bd-4db0-a1ad-ad3c975822d7" alt="Rivan" style={{'width': '24px', 'height': '24px', 'objectFit': 'contain'}} /></span>
      <div style={{'display': 'flex', 'flexDirection': 'column', 'lineHeight': '1.05'}}>
        <span style={{'fontSize': '15px', 'fontWeight': '800', 'color': '#fff', 'letterSpacing': '.2px'}}>RIVAN REALTY</span>
        <span style={{'fontSize': '9px', 'fontWeight': '700', 'color': '#7fae8c', 'letterSpacing': '2px'}}>ADMIN CONSOLE</span>
      </div>
    </div>
  ...
  <main style={{'flex': '1', 'minWidth': '0', 'display': 'flex', 'flexDirection': 'column'}}>
    <header style={{'flex': 'none', 'height': '72px', 'background': '#fff', 'borderBottom': '1px solid #e7ede3', 'display': 'flex', 'alignItems': 'center', 'gap': '14px', 'padding': '0 22px'}}>
      ...
      <button onClick={goProfile} style={{'display': 'flex', 'alignItems': 'center', 'gap': '10px', 'border': '1px solid #e7ede3', 'borderRadius': '12px', 'background': '#fff', 'padding': '5px 12px 5px 5px', 'cursor': 'pointer'}}>
        <span style={{'width': '34px', 'height': '34px', 'borderRadius': '9px', 'background': 'linear-gradient(160deg,#12351d,#0f2e1a)', 'color': '#fff', 'fontSize': '12px', 'fontWeight': '800', 'display': 'flex', 'alignItems': 'center', 'justifyContent': 'center'}}>AU</span>
    ...
    <div className="ad-scroll" style={{'flex': '1', 'overflowY': 'auto', 'padding': '22px'}}>
      ...
      <div className="ad-fade" style={{'display': 'flex', 'flexDirection': 'column', 'gap': '18px', 'maxWidth': '1560px'}}>
          ...
          { kpis.map((k, index) => (
            <div style={{'background': '#fff', 'border': '1px solid #e7ede3', 'borderRadius': '18px', 'padding': '18px', 'boxShadow': '0 14px 34px -28px rgba(18,53,29,.55)'}}>
              <div style={{'display': 'flex', 'justifyContent': 'space-between', 'alignItems': 'flex-start'}}>
                ...
                <span style={{'width': '34px', 'borderRadius': '10px', 'background': k.iconBg, 'display': 'flex', 'alignItems': 'center', 'justifyContent': 'center', 'flex': 'none'}}><svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke={k.iconColor} stroke-width="1.9" stroke-linecap="round" stroke-linejoin="round"><path d={k.icon}></path></svg></span>
              </div>
          ...
          <section style={{'background': '#fff', 'border': '1px solid #e7ede3', 'borderRadius': '18px', 'padding': '18px', 'boxShadow': '0 14px 34px -28px rgba(18,53,29,.55)'}}>
            ...
            <div style={{'display': 'flex', 'flexDirection': 'column'}}>
              { topAgents.map((a, index) => (
                <div style={{'display': 'center', 'gap': '12px', 'padding': '11px'}} 0;border-top:a.border>
                  <span style={{'width': '24px', 'fontSize': '13px', 'fontWeight': '800', 'color': '#a2b0a4'}}>{a.rank}</span>
                  <span style={{'width': '38px', 'borderRadius': '11px', 'background': a.avatarBg, 'color': '#fff', 'fontSize': '13px', 'fontWeight': '800', 'display': 'flex', 'alignItems': 'center', 'justifyContent': 'center', 'flex': 'none'}}>{a.initials}</span>
          ...
          <section style={{'background': '#fff', 'border': '1px solid #e7ede3', 'borderRadius': '18px', 'padding': '18px', 'boxShadow': '0 14px 34px -28px rgba(18,53,29,.55)'}}>
            ...
            <div style={{'display': 'flex', 'flexDirection': 'column'}}>
              { recentBookings.map((b, index) => (
                <div style={{'display': 'center', 'gap': '12px', 'padding': '11px'}} 0;border-top:b.border>
                  <span style={{'width': '38px', 'borderRadius': '11px', 'background': b.avatarBg, 'color': '#fff', 'fontSize': '13px', 'fontWeight': '800', 'display': 'flex', 'alignItems': 'center', 'justifyContent': 'center', 'flex': 'none'}}>{b.initials}</span>
          ...
          <section style={{'background': '#fff', 'border': '1px solid #e7ede3', 'borderRadius': '18px', 'padding': '18px', 'boxShadow': '0 14px 34px -28px rgba(18,53,29,.55)'}}>
            ...
            <div style={{'display': 'flex', 'alignItems': 'center', 'gap': '16px', 'flexWrap': 'wrap'}}>
              ...
              <div style={{'flex': '1', 'minWidth': '120px', 'display': 'flex', 'flexDirection': 'column', 'gap': '9px'}}>
                { visitLegend.map((l, index) => (<div style={{'display': 'flex', 'alignItems': 'center', 'gap': '9px'}}><span style={{'width': '11px', 'borderRadius': '3px', 'background': l.color, 'flex': 'none'}}></span><span style={{'flex': '1', 'fontSize': '12px', 'fontWeight': '600', 'color': '#3d4f40'}}>{l.label}</span><span style={{'fontSize': '12px', 'fontWeight': '800', 'color': '#12351d'}}>{l.value}</span></div>))}
              </div>
            </div>
          </section>
        </div>
          ...
          <section style={{'background': '#fff', 'border': '1px solid #e7ede3', 'borderRadius': '18px', 'padding': '18px', 'boxShadow': '0 14px 34px -28px rgba(18,53,29,.55)'}}>
            ...
            <div style={{'display': 'flex', 'alignItems': 'center', 'gap': '16px', 'flexWrap': 'wrap'}}>
              ...
              <div style={{'flex': '1', 'minWidth': '120px', 'display': 'flex', 'flexDirection': 'column', 'gap': '8px'}}>
                { sourceLegend.map((l, index) => (<div style={{'display': 'flex', 'alignItems': 'center', 'gap': '9px'}}><span style={{'width': '11px', 'borderRadius': '3px', 'background': l.color, 'flex': 'none'}}></span><span style={{'flex': '1', 'fontSize': '11.5px', 'fontWeight': '600', 'color': '#3d4f40'}}>{l.label}</span><span style={{'fontSize': '11.5px', 'fontWeight': '800', 'color': '#12351d'}}>{l.value}</span></div>))}
              </div>
            </div>
          </section>
          ...
          <section style={{'background': '#fff', 'border': '1px solid #e7ede3', 'borderRadius': '18px', 'padding': '18px', 'boxShadow': '0 14px 34px -28px rgba(18,53,29,.55)'}}>
            ...
            <div style={{'display': 'grid', 'gridTemplateColumns': '1fr 1fr', 'gap': '11px'}}>
              { propStats.map((p, index) => (
                <div style={{'background': p.bg}}:13px;padding:14px><div style={{'display': 'flex', 'alignItems': 'center', 'gap': '8px'}}><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke={p.color} stroke-width="1.9" stroke-linecap="round" stroke-linejoin="round"><path d={p.icon}></path></svg><span style={font}-size:11px;font-weight:700;color:p.color>{p.label}</span></div><p style={{'margin': '8px 0 0', 'fontSize': '20px', 'fontWeight': '800', 'color': '#12351d'}}>{p.value}</p></div>
              ))}
            </div>
          ...
          <section style={{'background': '#fff', 'border': '1px solid #e7ede3', 'borderRadius': '18px', 'padding': '18px', 'boxShadow': '0 14px 34px -28px rgba(18,53,29,.55)'}}>
            ...
            <div style={{'display': 'flex', 'flexDirection': 'column'}}>
              { payOverview.map((p, index) => (
                <div style={{'display': 'center', 'justifyContent': 'space-between', 'padding': '13px'}} 0;border-top:p.border>
                  <div><p style={{'margin': '0', 'fontSize': '12px', 'fontWeight': '600', 'color': '#8a9a8c'}}>{p.label}</p><p style={{'margin': '4px'}} 0 0;font-size:17px;font-weight:800;color:p.color>{p.value}</p></div>
                  <span style={font}-size:11.5px;font-weight:800;color:p.deltaColor>{p.delta}</span>
                </div>
              ))}
            </div>
        ...
        <div className="ad-g2" style={{'gridTemplateColumns': '1.5fr 1fr'}}>
          ...
          <section style={{'background': '#fff', 'border': '1px solid #e7ede3', 'borderRadius': '18px', 'padding': '18px', 'boxShadow': '0 14px 34px -28px rgba(18,53,29,.55)'}}>
            ...
            <div style={{'display': 'flex', 'flexDirection': 'column'}}>
              { alerts.map((a, index) => (
                <div style={{'display': 'center', 'gap': '12px', 'padding': '12px'}} 0;border-top:a.border>
                  <span style={{'width': '36px', 'borderRadius': '11px', 'background': a.bg, 'display': 'flex', 'alignItems': 'center', 'justifyContent': 'center', 'flex': 'none'}}><svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke={a.color} stroke-width="1.9" stroke-linecap="round" stroke-linejoin="round"><path d={a.icon}></path></svg></span>
      ...
      <div className="ad-fade" style={{'display': 'flex', 'flexDirection': 'column', 'gap': '18px', 'maxWidth': '1400px'}}>
        ...
        <section style={{'background': 'linear-gradient(120deg,#0f2e1a,#1a5e2e)', 'borderRadius': '20px', 'padding': '26px', 'display': 'flex', 'alignItems': 'center', 'gap': '20px', 'flexWrap': 'wrap', 'boxShadow': '0 20px 44px -30px rgba(18,53,29,.7)'}}>
          <span style={{'width': '82px', 'height': '82px', 'borderRadius': '24px', 'background': 'rgba(255,255,255,.14)', 'color': '#fff', 'fontSize': '28px', 'fontWeight': '800', 'display': 'flex', 'alignItems': 'center', 'justifyContent': 'center', 'border': '2px solid rgba(255,255,255,.25)'}}>AU</span>
          ...
          <div style={{'display': 'flex', 'gap': '10px', 'flexWrap': 'wrap'}}>
            ...
            <button style={{'height': '42px', 'padding': '0 18px', 'border': '1px solid rgba(255,255,255,.3)', 'borderRadius': '12px', 'background': 'transparent', 'color': '#fff', 'fontFamily': 'inherit', 'fontSize': '12.5px', 'fontWeight': '700', 'cursor': 'pointer'}}>Logout</button>
          </div>
        </section>

        {/* account statistics */}
        <div className="ad-kpi">
          { adminStats.map((k, index) => (
        ...
        <div className="ad-g2">
          ...
          <section style={{'background': '#fff', 'border': '1px solid #e7ede3', 'borderRadius': '18px', 'padding': '20px', 'boxShadow': '0 14px 34px -28px rgba(18,53,29,.55)'}}>
            ...
            <div style={{'display': 'flex', 'flexDirection': 'column', 'gap': '12px'}}>{ personalInfo.map((i, index) => (<div style={{'display': 'space-between', 'gap': '12px', 'borderBottom': i.border, 'paddingBottom': '10px'}}><span style={{'fontSize': '12px', 'fontWeight': '600', 'color': '#8a9a8c'}}>{i.label}</span><span style={{'fontSize': '12.5px', 'fontWeight': '700', 'color': '#16231a', 'textAlign': 'right'}}>{i.value}</span></div>))}</div>
          </section>
          {/* company info */}
          <section style={{'background': '#fff', 'border': '1px solid #e7ede3', 'borderRadius': '18px', 'padding': '20px', 'boxShadow': '0 14px 34px -28px rgba(18,53,29,.55)'}}>
            <h3 style={{'margin': '0 0 14px', 'fontSize': '15px', 'fontWeight': '800', 'color': '#12351d'}}>Company Information</h3>
            <div style={{'display': 'flex', 'flexDirection': 'column', 'gap': '12px'}}>{ companyInfo.map((i, index) => (<div style={{'display': 'space-between', 'gap': '12px', 'borderBottom': i.border, 'paddingBottom': '10px'}}><span style={{'fontSize': '12px', 'fontWeight': '600', 'color': '#8a9a8c'}}>{i.label}</span><span style={{'fontSize': '12.5px', 'fontWeight': '700', 'color': '#16231a', 'textAlign': 'right'}}>{i.value}</span></div>))}</div>
          </section>
        </div>
        ...
        <div className="ad-g2">
          ...
          <section style={{'background': '#fff', 'border': '1px solid #e7ede3', 'borderRadius': '18px', 'padding': '20px', 'boxShadow': '0 14px 34px -28px rgba(18,53,29,.55)'}}>
            ...
            <div style={{'display': 'flex', 'flexDirection': 'column'}}>
              { security.map((s, index) => (
                <div style={{'display': 'center', 'gap': '12px', 'padding': '13px'}} 0;border-top:s.border>
          ...
          <section style={{'background': '#fff', 'border': '1px solid #e7ede3', 'borderRadius': '18px', 'padding': '20px', 'boxShadow': '0 14px 34px -28px rgba(18,53,29,.55)'}}>
            ...
            <div style={{'display': 'flex', 'flexDirection': 'column', 'gap': '14px'}}>
              { usage.map((u, index) => (
                <div><div style={{'display': 'flex', 'justifyContent': 'space-between', 'marginBottom': '6px'}}><span style={{'fontSize': '12px', 'fontWeight': '600', 'color': '#3d4f40'}}>{u.label}</span><span style={{'fontSize': '12px', 'fontWeight': '800', 'color': '#12351d'}}>{u.value}</span></div><div style={{'height': '8px', 'borderRadius': '6px', 'background': '#eef3ec', 'overflow': 'hidden'}}><div style={{'width': u.pct}}:100%;border-radius:6px;background:u.color></div></div></div>
              ))}
            </div>
          ...
          <section style={{'background': '#fff', 'border': '1px solid #e7ede3', 'borderRadius': '18px', 'padding': '20px', 'boxShadow': '0 14px 34px -28px rgba(18,53,29,.55)'}}>
            ...
            <div style={{'display': 'flex', 'flexDirection': 'column'}}>
              { notifPrefs.map((n, index) => (
                <div style={{'display': 'center', 'gap': '12px', 'padding': '11px'}} 0;border-top:n.border><span style={{'flex': '1', 'fontSize': '12.5px', 'fontWeight': '600', 'color': '#16231a'}}>{n.label}</span><button onClick={n.toggle} style={n.trackStyle}><span style={n.knobStyle}></span></button></div>
              ))}
            </div>
          </section>
          <section style={{'background': '#fff', 'border': '1px solid #e7ede3', 'borderRadius': '18px', 'padding': '20px', 'boxShadow': '0 14px 34px -28px rgba(18,53,29,.55)'}}>
        ...
        <div style={{'display': 'grid', 'gridTemplateColumns': 'repeat(auto-fill,minmax(320px,1fr))', 'gap': '16px'}}>
          { projects.map((p, index) => (
            <div style={{'background': '#fff', 'border': '1px solid #e7ede3', 'borderRadius': '18px', 'overflow': 'hidden', 'boxShadow': '0 14px 34px -28px rgba(18,53,29,.55)'}}>
              <div style={{'height': p.grad, 'position': 'relative'}}>
      ...
      <div className="ad-fade" style={{'maxWidth': '1560px'}}>
        <section style={{'background': '#fff', 'border': '1px solid #e7ede3', 'borderRadius': '18px', 'padding': '18px', 'boxShadow': '0 14px 34px -28px rgba(18,53,29,.55)'}}>
          ...
          <div className="ad-tbl-wrap">
            { tableCols.map((h, index) => ())}{ tableRows.map((r, index) => (
                  ))}{ r.map((c, index) => ())}<table style={{'width': '100%', 'borderCollapse': 'collapse', 'minWidth': '720px'}}>
              <thead><tr style={{'textAlign': 'left'}}><th style={{'fontSize': '11px', 'fontWeight': '800', 'color': '#8a9a8c', 'textTransform': 'uppercase', 'letterSpacing': '.4px', 'padding': '0 14px 12px 0'}}>{h}</th></tr></thead>
              <tbody>
                <tr style={{'borderTop': '1px solid #eef3ec'}}><td style={{'padding': '13px 14px 13px 0'}}><span style={c.style}>{c.v}</span></td></tr>
...
<script type="text/x-dc" data-dc-script="" data-props="{&quot;$preview&quot;:{&quot;width&quot;:1440,&quot;height&quot;:1024},&quot;adminName&quot;:{&quot;editor&quot;:&quot;text&quot;,&quot;default&quot;:&quot;Admin User&quot;,&quot;tsType&quot;:&quot;string&quot;}}">
class Component extends DCLogic {
  state = {
    page:'dashboard', sideOpen:false, areaFilter:'All',
    perms:{ 'User Management':true,'Agent Management':true,'Customer Management':true,'Property Management':true,'Payment Management':true,'Reports':true,'Marketing':false,'Notifications':true,'System Settings':true },
    notif:{ 'New Customer Registration':true,'New Agent Registration':true,'Site Visit Bookings':true,'Payments':true,'Booking Confirmations':true,'Support Tickets':false,'System Alerts':true },
  };
  nav(p){ this.setState({ page:p, sideOpen:false }); }
  av(i){ const bg=['#1a5e2e','#2f6b7a','#8a5a2e','#5a3f8a','#2a6fdb','#b5772e','#3f9159','#a03b5a']; return bg[i%bg.length]; }
  ini(name){ return name.split(' ').map(w=>w[0]).slice(0,2).join('').toUpperCase(); }
  chart(vals,stroke,fill){ const w=300,h=95,pad=6; const max=Math.max(...vals),min=Math.min(...vals),rng=(max-min)||1;
  ...
  renderVals(){
    const s=this.state, page=s.page;
    const adminName=this.props.adminName ?? 'Admin User';
    ...
    const nav=NAV.map(([id,label,icon,badge])=>({
      label, icon, go:()=>this.nav(id), badge: badge||'',
      style: (page===id)
        ? 'display:flex;align-items:center;gap:12px;width:100%;padding:11px 13px;border:none;border-radius:11px;background:#1a5e2e;color:#fff;font-family:inherit;font-size:13px;font-weight:700;cursor:pointer'
        : 'display:flex;align-items:center;gap:12px;width:100%;padding:11px 13px;border:none;border-radius:11px;background:transparent;color:#9fc0a6;font-family:inherit;font-size:13px;font-weight:600;cursor:pointer'
    }));

    const TITLES={ dashboard:['Admin Dashboard','Platform-wide overview and controls'],
    ...
    const pill=(txt,type)=>{const m={success:['#e6f4ea','#1a8a4a'],warn:['#fdf3e8','#c2711f'],info:['#eef2fb','#2a6fdb'],danger:['#fdeaea','#c93b3b']};const [bg,c]=m[type]||['#eef3ec','#3d4f40'];return `font-size:10.5px;font-weight:800;padding:5px 11px;border-radius:20px;background:${bg};color:${c};white-space:nowrap`;};
    ...
    const charts=[
      {title:'Leads Overview',total:'5,678',delta:'▲ 12%',labels,...this.chart([1100,1350,1220,1600,1900],'#1a5e2e','rgba(26,94,46,.10)')},
      {title:'Bookings Overview',total:'1,234',delta:'▲ 10%',labels,...this.chart([260,340,300,420,560],'#e2822a','rgba(226,130,42,.10)')},
      {title:'Sales Overview',total:'₹45.67 Cr',delta:'▲ 15%',labels,...this.chart([18,26,22,34,46],'#7a4fce','rgba(122,79,206,.10)')},
    ];
    const topAgents=[
      ['Sravani K','₹2.45 Cr','₹24,56,000'],['Vikram Reddy','₹1.89 Cr','₹18,90,000'],['Rohan K','₹1.25 Cr','₹12,50,000'],['Anita Sharma','₹1.10 Cr','₹11,00,000'],['Karthik R','₹98 L','₹9,80,000'],
    ].map((a,i)=>({rank:'#'+(i+1),name:a[0],sales:a[1],commission:a[2],initials:this.ini(a[0]),avatarBg:this.av(i),border:i===0?'none':'1px solid #eef3ec'}));
    ...
    ].map((b,i)=>({name:b[0],plot:b[1],amount:b[2],date:b[3],initials:this.ini(b[0]),avatarBg:this.av(i),border:i===0?'none':'1px solid #eef3ec'}));
    ...
    // ---- profile data ----
    const adminStats=[
      {label:'Total Customers',value:'2,456'},{label:'Total Agents',value:'186'},{label:'Total Sub Agents',value:'642'},{label:'Total Properties',value:'6,542'},{label:'Total Revenue',value:'₹45.67 Cr'},
    ];
    const bd=(arr)=>arr.map((x,i)=>({label:x[0],value:x[1],border:i===arr.length-1?'none':'1px solid #eef3ec'}));
    const personalInfo=bd([['Full Name','Admin User'],['Employee ID','RVN-ADM-001'],['Designation','Super Admin'],['Email','admin@rivanrealty.com'],['Mobile','+91 90000 12345'],['Office Location','Head Office, Vizag'],['Department','Administration'],['Date Joined','01 Jan 2022']]);
    ...
    const roles=['Super Admin','Admin','Finance Admin','Operations Admin','Marketing Admin'].map((r,i)=>({label:r,
      style: i===0?'font-size:12px;font-weight:800;padding:8px 15px;border-radius:20px;background:#1a5e2e;color:#fff':'font-size:12px;font-weight:700;padding:8px 15px;border-radius:20px;background:#f4f7f2;color:#3d4f40;border:1px solid #e7ede3'}));

    const permKeys=Object.keys(s.perms);
    const tgl=(on)=>({trackStyle:`width:44px;height:26px;border-radius:16px;border:none;cursor:pointer;position:relative;flex:none;background:${on?'#1a5e2e':'#d5ddd2'};transition:background .2s`,
      knobStyle:`position:absolute;top:3px;left:${on?'21px':'3px'};width:20px;height:20px;border-radius:50%;background:#fff;transition:left .2s;box-shadow:0 2px 5px rgba(0,0,0,.2)`});
    const permissions=permKeys.map(k=>{const on=s.perms[k];const t=tgl(on);return {label:k,trackStyle:t.trackStyle,knobStyle:t.knobStyle,toggle:()=>this.setState(st=>({perms:{...st.perms,[k]:!st.perms[k]}}))};});
    ...
    const notifKeys=Object.keys(s.notif);
    const notifPrefs=notifKeys.map((k,i)=>{const on=s.notif[k];const t=tgl(on);return {label:k,trackStyle:t.trackStyle,knobStyle:t.knobStyle,border:i===0?'none':'1px solid #eef3ec',toggle:()=>this.setState(st=>({notif:{...st.notif,[k]:!st.notif[k]}}))};});
    ...
    const areaChips=['All',...Object.keys(areaAgg)].map(a=>({label:a, pick:()=>this.setState({areaFilter:a}),
      style: s.areaFilter===a
        ? 'height:38px;padding:0 16px;border-radius:11px;border:none;background:#1a5e2e;color:#fff;font-family:inherit;font-size:12.5px;font-weight:700;cursor:pointer'
        : 'height:38px;padding:0 16px;border-radius:11px;border:1px solid #e2e8e0;background:#fff;color:#3d4f40;font-family:inherit;font-size:12.5px;font-weight:600;cursor:pointer'}));
    const projects=PROJ.filter(p=>s.areaFilter==='All'||p[2]===s.areaFilter).map(p=>({
    ...
    // ---- per-tab data tables ----
    const cC=(v,strong)=>({v,style:strong?'font-size:13px;font-weight:700;color:#16231a':'font-size:13px;color:#3d4f40'});
    const cM=(v)=>({v,style:'font-size:13px;font-weight:800;color:#1a5e2e'});
    const cP=(v,t)=>({v,style:pill(v,t)+';display:inline-block'});
    const TABLES={
      users:{title:'All Users',cols:['Name','Role','Email','Phone','Status','Joined'],rows:[
        [cC('Sravani K',1),cC('Agent'),cC('sravani@rivan.com'),cC('+91 98765 43210'),cP('Active','success'),cC('12 Jan 2023')],
      ...
      leads:{title:'All Leads',cols:['Name','Source','Project','Assigned To','Status','Date'],rows:[
        [cC('Vijay Kumar',1),cC('Website'),cC('Emerald Estate'),cC('Sravani K'),cP('New','info'),cC('22 May 2025')],
        ...
        [cC('Deepa Nair',1),cC('Referral'),cC('Palm Grove'),cC('Sravani K'),cP('Contacted','warn'),cC('19 May 2025')],
      ]},
      ...
      sitevisits:{title:'All Site Visits',cols:['Customer','Project','Plot','Date & Time','Agent','Status'],rows:[
        [cC('Rohan Verma',1),cC('Emerald Estate'),cC('A-120'),cC('23 May, 10:00 AM'),cC('Sravani K'),cP('Pending','warn')],
      ...
      commission:{title:'Agent Commission',cols:['Agent','Bookings','Sales','Commission','Payout','Status'],rows:[
        [cC('Sravani K',1),cC('5'),cC('₹2.45 Cr'),cM('₹24,56,000'),cC('01 Jun 2025'),cP('Paid','success')],
      ...
      reports:{title:'Generated Reports',cols:['Report','Period','Generated By','Format','Date'],rows:[
        [cC('Leads Report',1),cC('May 2025'),cC('Admin User'),cP('PDF','danger'),cC('22 May 2025')],
        [cC('Sales Report',1),cC('Q2 2025'),cC('Finance Admin'),cP('XLSX','success'),cC('21 May 2025')],
        [cC('Site Visit Report',1),cC('May 2025'),cC('Admin User'),cP('PDF','danger'),cC('20 May 2025')],
      ...
      content:{title:'Content Management',cols:['Title','Type','Section','Updated By','Status'],rows:[
        [cC('Home Banner — Monsoon',1),cC('Banner'),cC('App Home'),cC('Admin User'),cP('Published','success')],
        [cC('Emerald Estate Brochure',1),cC('PDF'),cC('Projects'),cC('Marketing Admin'),cP('Published','success')],
        [cC('About Rivan Reality',1),cC('Page'),cC('Website'),cC('Admin User'),cP('Draft','warn')],
      ...
      audit:{title:'Audit Logs',cols:['Date','Time','Action','User','Status'],rows:[
        [cC('22 May 2025'),cC('09:42 AM'),cC('Created Property',1),cC('Admin User'),cP('Success','success')],
        [cC('22 May 2025'),cC('09:15 AM'),cC('Assigned Agent',1),cC('Admin User'),cP('Success','success')],
        [cC('21 May 2025'),cC('06:30 PM'),cC('Approved Booking',1),cC('Finance Admin'),cP('Success','success')],
        [cC('21 May 2025'),cC('11:05 AM'),cC('Deleted User',1),cC('Super Admin'),cP('Reverted','warn')],
        [cC('20 May 2025'),cC('03:48 PM'),cC('Updated Payment',1),cC('Finance Admin'),cP('Success','success')],
      ]},
    ...
    return {
      adminName, pageTitle, pageSub, nav,
      sideOpen:s.sideOpen, sideCls:s.sideOpen?'open':'',
      openSide:()=>this.setState({sideOpen:true}), closeSide:()=>this.setState({sideOpen:false}),
      goDashboard:()=>this.nav('dashboard'), goProfile:()=>this.nav('profile'),
      goUsers:()=>this.nav('users'), goBookings:()=>this.nav('bookings'),
      goProperties:()=>this.nav('properties'), goPayments:()=>this.nav('payments'),
      goAudit:()=>this.nav('audit'), goSettings:()=>this.nav('settings'),
      isDashboard:page==='dashboard', isProfile:page==='profile',
      isProperties:page==='properties', isTable:!!tableCfg,
      isGeneric: page!=='dashboard' && page!=='profile' && page!=='properties' && !tableCfg,
      genericIcon: GEN[page]||'M3 13h8V3H3z',
      areaSummary, areaChips, projects,
      tableTitle: tableCfg?tableCfg.title:'', tableCols: tableCfg?tableCfg.cols:[], tableRows: tableCfg?tableCfg.rows:[],
      kpis, charts, topAgents, recentBookings, visitLegend, sourceLegend,
      propStats, payOverview, recentActivities, alerts,
      adminStats, personalInfo, companyInfo, roles, permissions,
      security, usage, notifPrefs, adminQuick, auditLogs,
    };
  }
}
</script>
