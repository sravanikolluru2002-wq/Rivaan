...
export default function MyLands() {
  ...
  <div className="rv-phone">
    ...
    <div style={{position: 'absolute', top: 0, left: 0, right: 0, height: '50px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '0 28px', fontSize: '13.5px', fontWeight: '700', color: statusColor, zIndex: 50, pointerEvents: 'none'}}>
        ...
        <div style={{'padding': '18px 22px 0'}}>
          ...
          <div style={{'marginTop': '16px', 'background': '#fff', 'border': '1px solid #eef3ec', 'borderRadius': '16px', 'padding': '4px 16px'}}>
            <div style={{'display': 'flex', 'alignItems': 'center', 'justifyContent': 'space-between', 'padding': '14px 0'}}>
              ...
              <button onClick={tog1} style={{width: '48px', height: '28px', borderRadius: '16px', border: 'none', cursor: 'pointer', position: 'relative', background: cz.a1track}}>
                <span style={{position: 'absolute', top: '3px', left: cz.a1knob, width: '22px', height: '22px', borderRadius: '50%', background: '#fff', boxShadow: '0 2px 5px rgba(0,0,0,.2)'}}></span>
              </button>
            </div>
            <div style={{'display': 'flex', 'alignItems': 'center', 'justifyContent': 'space-between', 'padding': '14px 0', 'borderTop': '1px solid #f0f4ee'}}>
              ...
              <button onClick={tog2} style={{width: '48px', height: '28px', borderRadius: '16px', border: 'none', cursor: 'pointer', position: 'relative', background: cz.a2track}}>
                <span style={{position: 'absolute', top: '3px', left: cz.a2knob, width: '22px', height: '22px', borderRadius: '50%', background: '#fff', boxShadow: '0 2px 5px rgba(0,0,0,.2)'}}></span>
              </button>
            </div>
          </div>
          )}
