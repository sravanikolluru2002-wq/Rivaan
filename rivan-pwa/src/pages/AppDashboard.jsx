...
export default function AppDashboard() {
  ...
  const openFirstProject = () => {
    openProject({ name: 'Emerald Estate', loc: 'Visakhapatnam', tag: 'Vizag', price: '₹4,500', grad: 'linear-gradient(150deg,#2f6b3a 0%,#6ba15a 55%,#c7dc9c 100%)' });
  };
  ...
  <div className="rv-phone">
    ...
    <div className="rv-scroll with-nav" style={{'position': 'absolute', 'inset': '0', 'overflowY': 'auto'}}>
      ...
      {isPropDetail && (
      <div className="rv-screen">
        <div style={{position: 'relative', height: '300px', background: sel.grad}}>
